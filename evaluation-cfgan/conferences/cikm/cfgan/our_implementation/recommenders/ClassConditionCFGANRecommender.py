...
class ClassConditionCFGANRecommender(CFGANRecommender):
    RECOMMENDER_NAME = "ClassConditionCFGANRecommender"
    ...
    def __init__(
        ...
        self.model: Optional[ClassConditionCFGANModel] = None
    ...
    def get_recommender_name(
        ...
        **kwargs,
        ...
        return (
            f"{ClassConditionCFGANRecommender.RECOMMENDER_NAME}_"
    ...
    def load_model(
        ...
        self.model = ClassConditionCFGANModel(
