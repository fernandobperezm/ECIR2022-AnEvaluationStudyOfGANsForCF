...
from recsys_framework.Utils.Mixins.PrettyRecommenderNameMixin import PrettyRecommenderNameMixin


class BaseRecommender(PrettyRecommenderNameMixin, object):
