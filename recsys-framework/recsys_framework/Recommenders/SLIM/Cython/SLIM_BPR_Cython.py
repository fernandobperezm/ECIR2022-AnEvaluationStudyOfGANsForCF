...
from recsys_framework.Recommenders.Recommender_utils import similarityMatrixTopK
...
class SLIM_BPR_Cython(BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300,
        ...
        from recsys_framework.Recommenders.SLIM.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
