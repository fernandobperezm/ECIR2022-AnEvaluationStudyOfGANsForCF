...
from recsys_framework.HyperparameterTuning.SearchAbstractClass import SearchAbstractClass
import traceback
...
LegacyState = Dict[Any, Any]
NonLegacyState = Tuple[str, np.ndarray, int, int, float]
RandomStateState = Union[LegacyState, NonLegacyState]
...
class SearchBayesianSkopt(SearchAbstractClass):
    ...
    def _resume_from_saved(
        ...
        #  Previously trained models did not save random_state. New ones will. For old ones,
        #  we just return None, for new ones, we return the saved RandomState.
        random_state: Optional[RandomStateState] = self.metadata_dict.get(
            'random_state',
            None
        )
        ...
        return hyperparameters_list_input, result_on_validation_list_input, random_state
    ...
    def search(self,
        ...
        :param seed. Seed to be used in the RandomState instance. Default value is 1234567890.
        :return:
        """
