...
##########                                                  ##########
######################################################################
from recsys_framework.Recommenders.NonPersonalizedRecommender import TopPop, Random, GlobalEffects

# KNN
from recsys_framework.Recommenders.KNN.UserKNNCFRecommender import UserKNNCFRecommender
from recsys_framework.Recommenders.KNN.ItemKNNCFRecommender import ItemKNNCFRecommender
...
from recsys_framework.Recommenders.MatrixFactorization.Cython.MatrixFactorization_Cython import MatrixFactorization_BPR_Cython,\
