...
from recsys_framework.Data_manager.DataReader_utils import download_from_URL, remove_features, load_CSV_into_SparseBuilder
...
class _AmazonReviewDataReader(DataReader):
    ...
    def _loadMetadata(self, file_path, if_new_item = "ignore"):
        ...
        from recsys_framework.Data_manager.TagPreprocessing import tagFilterAndStemming
        import itertools
