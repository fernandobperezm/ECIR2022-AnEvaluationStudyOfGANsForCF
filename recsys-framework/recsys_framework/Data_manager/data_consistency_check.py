...
def assert_URM_ICM_mapper_consistency(URM_DICT, user_original_ID_to_index, item_original_ID_to_index,
    ...
    assert n_items_URM == len(item_original_ID_to_index), print_preamble + f"(n_items_URM={n_items_URM}/" \
                                                                           f"len(item_original_ID_to_index)={len(item_original_ID_to_index)}) item ID-to-index " \
                                                                           f"mapper contains a " \
                                                                           "number of keys different then the number of items"
