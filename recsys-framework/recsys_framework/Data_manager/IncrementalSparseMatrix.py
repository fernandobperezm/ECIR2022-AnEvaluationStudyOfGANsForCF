...
def fix_mapper(method):
    # Sometimes these mappers have keys as numpy integers, however, these cannot be properly serialized by the
    # json library. This function ensures that all these keys are transformed to Python integers.

    def inner(
        *args: tuple[Any, ...],
        **kwargs: dict[str, Any]
    ) -> dict[Any, Any]:
        mapper: dict[Any, Any] = method(*args, **kwargs)
